...
public class VentanaBuscaminas extends javax.swing.JFrame {
    ...
    Boton [][] arrayBotones = new Boton[filas][columnas];
     //declaro una arrayList para ir guardando la lista de botones que
    //tengo que verificar
    ...
    private void ponUnaBomba(){
       ...
       arrayBotones[f][c].setText("Bomba");
    }
    ...
    public VentanaBuscaminas() {
        ...
        //Aqui no debemos de introducir este metodo
        //cuentaMinas();
    }
    ...
    private void botonPulsado(MouseEvent e){
        ...
        //sino que nos cuente las minas y si pulsamos el boton y hay bomba que nos
        //lo indique
        else{cuentaMinas();
        if(miBoton.bomba==1){
            
            
            miBoton.setText("Bomba");
        }
            //si es una bomba-->explota y se acaba la partida
            ArrayList <Boton> listaDeCasillasAMirar = new ArrayList();
            //añado el boton que ha sido pulsado
                ...
                for (int k=-1;k<2;k++){
                    for (int m=-1;m<2;m++){
                        if((b.x + k >= 0)&&
                           ...
                           (b.x + k < filas)&&
                           (b.y + m < columnas)){
                            //si el boton de esa posicion esta habilitado
                            //es que no lo chequeado todavia
